                ...
                <div className="w-8/12 h-4/5 px-8 pt-6 bg-white rounded-lg shadow-md flex flex-row">
                    ...
                    <div className={"w-2/6 h-full pr-3 pl-8 justify-center flex"}>
                        <div className={"mt-32 w-full"}>
                            <Button className={"w-full h-fit text-2xl"} onClick={() => {router.push('/club/events/new')}}>New Event</Button>
                            <Button className={"w-full h-fit text-2xl text-wrap mt-4"} onClick={() => {router.push('/club/events/reimbursement')}}>Request Reimbursement</Button>
                            <Separator className={"mt-4 text-neutral-800 bg-gray-800"}/>
                            <Button className={"w-full h-fit text-2xl mt-4"} onClick={() => {router.push('/club/status')}}>Request Status</Button>
                        </div>
                    </div>
                </div>
